...
DEFAULT_CONFIG = {
    ...
    # 仅用于客户报价的加工费折扣，不改变设备负荷或真实生产工时。
    "batch_processing_discounts": [
        {"最小数量": 1, "最大数量": 4, "加工费系数": 1.00},
        {"最小数量": 5, "最大数量": 9, "加工费系数": 0.98},
        {"最小数量": 10, "最大数量": 49, "加工费系数": 0.95},
        {"最小数量": 50, "最大数量": 99, "加工费系数": 0.90},
        {"最小数量": 100, "最大数量": 999999, "加工费系数": 0.85},
    ],
    "surface_treatments": {
